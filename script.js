function CalendarApp(date) {
  ...
  this.quotes = ['İnsanın zihni neyi kavrayabilir ve inanabilirse onu başarabilir. –Napoleon Hill', 'Başarılı olmaya değil, değerli olmaya çalışın. –Albert Einstein',
   'Bir ormanda iki yol birbirinden ayrıldı ve ben - daha az gidilen yolu aldım ve bu her şeyi değiştirdi.  –Robert Frost', 
   'Başarımı şuna bağlıyorum: Hiçbir zaman mazeret vermedim veya kabul etmedim. –Florence Nightingale',
    'Yapmadığınız çekimlerin% 100ünü kaçırırsınız. –Wayne Gretzky', 
    'En zor şey harekete geçme kararıdır, gerisi sadece azimdir. –Amelia Earhart',
     'Her vuruş beni bir sonraki eve gidişe yaklaştırıyor. –Babe Ruth',
      '  Amacın kesinliği, tüm başarının başlangıç ​​noktasıdır. –W. Clement Stone',
       'Hayat, almak ve sahip olmakla ilgili değildir, vermek ve olmakla ilgilidir. –Kevin Kruse', 
       ' Başka planlar yapmakla meşgulken hayat sana olan şeydir. –John Lennon',
        'Düşündüğümüz şey oluruz. –Earl Nightingale',
         '  Hayat, bana olanların% 10u ve ona nasıl tepki verdiğimin% 90ıdır. –Charles Swindoll',
          'İnsanların güçlerinden vazgeçmelerinin en yaygın yolu, güçlerinin olmadığını düşünmektir. –Alice Walker',
           ' Zihin her şeydir. Ne olacağını düşünüyorsun.   –Buddha',
            'Kazanmak her şey değildir, ancak kazanmak istemek demektir. –Vince Lombardi', 
            ' Her çocuk bir sanatçıdır. Sorun, büyüdüğünde nasıl sanatçı olarak kalacağıdır.  –Pablo Picasso', 
            ' Kıyı görüşünü kaybetme cesaretine sahip olana kadar okyanusu asla geçemezsiniz. –Christopher Columbus',
             'İnsanların söylediklerinizi unutacağını, yaptığınızı unutacağını ama onlara nasıl hissettirdiğinizi asla unutmayacağını öğrendim. –Maya Angelou', 
             ' Ya günü koşarsın ya da gün seni koşar. –Jim Rohn', 
             'Yapabileceğinizi ya da yapamayacağınızı düşünseniz de haklısınız. –Henry Ford',
              'Hayatınızdaki en önemli iki gün, doğduğunuz gün ve nedenini öğrendiğiniz gündür. –Mark Twain',
               'Ne yapabilirsen ya da yapabileceğini hayal et, başla. Cesaretin içinde deha, güç ve sihir vardır. –Johann Wolfgang von Goethe', 
               'En iyi intikam büyük bir başarıdır –Frank Sinatra',
                'İnsanlar genellikle motivasyonun uzun sürmediğini söyler. Banyo yapmak da öyle. Bu yüzden her gün tavsiye ediyoruz.. –Zig Ziglar', 
                'Hayat kişinin cesaretiyle orantılı olarak küçülür veya genişler. –Anais Nin',
                 'İçinizde “resim yapamazsınız” dediğiniz bir ses duyarsanız, o zaman kesinlikle boyayın ve o ses susturulacaktır.. –Vincent Van Gogh',
                  'Eleştiriden kaçınmanın tek bir yolu var: hiçbir şey yapmayın, hiçbir şey söylemeyin ve hiçbir şey olmayın. –Aristotle', 
                  'İsteyin, size verilecektir; arama ve bulacaksın; kapıyı çalın ve kapı sizin için açılacaktır. . –Jesus', 
                  'Olmak istediğiniz tek kişi, olmaya karar verdiğiniz kişidir. –Ralph Waldo Emerson', 
                  'Hayallerinize güvenle gidin. Hayal ettiğin hayatı yaşa. –Henry David Thoreau', 
                   'Bir kişiye sorumluluk yüklemekten ve ona güvendiğinizi bilmesini sağlamaktan daha fazla yardımcı olabilecek çok az şey vardır.  –Booker T. Washington'];
  this.apts = [
    {
      name: 'Finish this web app',
      endTime: new Date(2020,11, 15, 23),
      startTime: new Date(2020, 11, 15, 21),
      day: new Date(2020,11, 15).toString()
    },
     {
      name: 'My Birthday!',
      endTime: new Date(2020, 11, 15, 23, 59),
      startTime: new Date(2020, 11,15, 0),
      day: new Date(2020,  11, 15).toString()
    },
    
  ];
  
  this.aptDates = [new Date(2020, 10, 26).toString(),new Date(2020, 10, 26).toString()];
  this.eles = {
  };
